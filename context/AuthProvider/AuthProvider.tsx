...
export const SessionProvider = ({
  ...
  const [accessToken, setAccessToken] = useState<string>(
    'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..rD-0uN-mec2VbG47rxdoly_v_cEWIT8iJyHdMBS9PLgQT1sCXb1-FVbPc5KcG5maDKVwg7tNKG1pxcpleGdqlA'
  );
